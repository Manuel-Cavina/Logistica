...
export function RegisterForm() {
  ...
  const { isSubmitting, submit, submitError } = useFormSubmit((values: RegisterFormFields) =>
      ...
      <CardContent className="mt-6">
        <form className="space-y-6" noValidate onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-1">
            ...
            />
            {getFieldError("role") ? (
              <p className="text-sm text-destructive/90">{getFieldError("role")}</p>
            ) : null}
          </div>
          ...
          <div className="space-y-1">
            ...
            />
            {getFieldError("email") ? (
              <p className="text-sm text-destructive/90">{getFieldError("email")}</p>
            ) : null}
          </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1">
                ...
                {getFieldError("password") ? (
                  <p className="text-sm text-destructive/90">{getFieldError("password")}</p>
                ) : null}
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1">
                  ...
                  />
                  {getFieldError("phone") ? (
                    <p className="text-sm text-destructive/90">{getFieldError("phone")}</p>
                  ) : null}
                </div>
